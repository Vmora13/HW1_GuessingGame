    ...
    public void onClick(View view) {
        if (view.getId() == R.id.validate_button) {
            ...
            if (strPrueba.isEmpty())
                Toast.makeText(this, "Digita un numero del 0001 al 1000", Toast.LENGTH_LONG).show();
            else {
                if (intNumeroAleatorio < Integer.parseInt(otpView.getText().toString()))
                {
                    Toast.makeText(this, "El valor correcto es menor", Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(this, "El valor correcto es mayor", Toast.LENGTH_SHORT).show();
                    intNumeroIntentos = intNumeroIntentos + 1;
                    lblNumeroIntentos.setText("Numero de intentos: " + intNumeroIntentos);
                }
                else
